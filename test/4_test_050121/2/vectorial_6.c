...
int main( int argc, char *argv[] ){
    ...
    for(int pixel_index = 0; pixel_index < n_pixels/3 ; pixel_index++){
       ...
       float *blue_avx_c = (float *) &b_avx;
        ...
        image_data_out[pixel_index*9] = image_data_out[pixel_index*9 +1] = image_data_out[pixel_index*9 +2] = (unsigned char) gray_avx[0]; 
        image_data_out[pixel_index*9+3] = image_data_out[pixel_index*9 +4] = image_data_out[pixel_index*9 +5] = (unsigned char)  gray_avx[3]; 
        image_data_out[pixel_index*9+6] = image_data_out[pixel_index*9 +7] = image_data_out[pixel_index*9 +8] = (unsigned char)  gray_avx[6]; 
    }
