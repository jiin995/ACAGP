...
int main( int argc, char *argv[] ){
    ...
    for(int pixel_index = 0; pixel_index < n_pixels/32; pixel_index++){
        ...
        __m256i_u r_avx = _mm256_set_epi8(image_data_in[pixel_index*96], image_data_in[pixel_index*96+3], image_data_in[pixel_index*96+6],
        ...
        __m256i_u g_avx = _mm256_set_epi8(image_data_in[pixel_index*96+1], image_data_in[pixel_index*96+4], image_data_in[pixel_index*96+7],
        ...
        __m256i_u b_avx = _mm256_set_epi8(image_data_in[pixel_index*96+2], image_data_in[pixel_index*96+5], image_data_in[pixel_index*96+8],
        ...
        for(int i=0; i<32; i++){
            ...
            //image_data_out[pixel_index*96+i*3] = image_data_out[pixel_index*96+i*3+1] = image_data_out[pixel_index*96+i*3+2] = gray_avx_c[0]; 
